...
2. **VIEWS** (Horizontal, Vertical, Subset, Grouped, Joined)
3. **SubQuery** (Single-row, Multi-row, Correlated, EXISTS)
...
13. **Relational Algebra** (π, σ, ⨝ operations)
14. **Database programming - JDBC**
15. **Normal Forms** (1NF, 2NF, 3NF, BCNF)

---

## **📚 THEORY ON COVERED TOPICS:**
...
- **⨝ (Join):** Natural join of tables
- **× (Cross Product):** Cartesian product
- **∪ (Union), − (Difference), ∩ (Intersection)**

### **13. JDBC (Java Database Connectivity)**
**Architecture:** Java App → JDBC API → JDBC Driver → Database
...
- ✅ **Query Optimization:** Efficient SQL writing
- ✅ **Transaction Management:** Ensuring data consistency
- ✅ **Security Implementation:** Views and procedures
- ✅ **Backup & Recovery:** Log-based techniques
- ✅ **Concurrency Handling:** Locking mechanisms
- ✅ **Programming Interface:** JDBC connectivity
